...
!function (t) {
  ...
  }), t.fn.editableform.buttons = '<button type="submit" class="btn btn-xs btn-success editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn btn-xs default editable-cancel"><i class="fa fa-times"></i></button>', t.fn.editableform.errorGroupClass = "has-error", t.fn.editableform.errorBlockClass = null
}(window.jQuery), function (t) {
  "use strict";
  ...
  t.fn.editableutils.inherit(e, t.fn.editabletypes.date), t.extend(e.prototype, {
    ...
    tpl: '<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-xs pull-left"/><span class="input-group-btn pull-left"><button class="btn default" type="button"><i class="fa fa-calendar"></i></button></span></div>',
    inputclass: "form-control input-xs",
